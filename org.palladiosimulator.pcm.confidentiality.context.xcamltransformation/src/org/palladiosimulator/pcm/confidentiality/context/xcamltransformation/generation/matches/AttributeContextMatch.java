...
public class AttributeContextMatch extends Match {
     ...
     * @param dataType - an expected data type of match
     */
    public AttributeContextMatch(String attributeValue, String dataType) {
        super(XACML3.ID_SUBJECT_CATEGORY_ACCESS_SUBJECT, XACML3.ID_FUNCTION_STRING_REGEXP_MATCH,
                String.format("%s:%s", ATTRIBUTE, dataType), attributeValue);
    }
}
