...
public class Policy {
	...
	/**
	 * Generates the XACML policy with the given matches and obligations. The
	 * different characteristics are mapped to different rules which are combined
	 * with OR.
	 * 
	 * @return the XACML policy representing the action defined in the attribute
	 *         found in {@code matches.get(0).get(0)}.
	 */
