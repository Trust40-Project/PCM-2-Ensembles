...
/**
 * Represents obligation expression(s) of an . Implementations of this interface can be used to create obligations
 * from contexts.
 * 
...
public interface Obligation {
	...
	/**
	 * Gets a list of XACML ObligationExpressionType of this obligation. 
	 * The default of this method is {@code getObligation()} as a list.
	 * If this behavior is not wanted, this method should be overridden.
	 * 
